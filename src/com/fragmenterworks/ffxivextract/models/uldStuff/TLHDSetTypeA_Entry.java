...
public class TLHDSetTypeA_Entry {
	private static SparseArray<Class<? extends TLHDSetTypeA_Entry_Item_Type>> tlhdATypes = new SparseArray<>();
	...
	public int size;
	public int count;
	public TLHDSetTypeA_Entry_Item[] frames;
	...
	public static TLHDSetTypeA_Entry_Item_Type getTLHDSetTypeAEntryItemType(int type, ByteBuffer data) {
	...
	public static class TLHDSetTypeA_Entry_Item {
		public int                          frame;
		public int                          size;
		public TLHDSetTypeA_Entry_Item_Type typeData;

		public TLHDSetTypeA_Entry_Item(ByteBuffer data, TLHDSetTypeA_Entry typeA) {
			int offset = data.position();
			frame = data.getInt();
			size = data.getShort();
	...
	public static abstract class TLHDSetTypeA_Entry_Item_Type {
		public TLHDSetTypeA_Entry_Item_Type(ByteBuffer data) {
	...
	public static class TLHDSetTypeA_Entry_Item_Type_1 extends TLHDSetTypeA_Entry_Item_Type {
		...
		public int   unk_node;
		public float float_0x06;
		public float float_0x0a;

		public TLHDSetTypeA_Entry_Item_Type_1(final ByteBuffer data) {
			super(data);
			int offset = data.position();
	...
	public static class TLHDSetTypeA_Entry_Item_Type_2 extends TLHDSetTypeA_Entry_Item_Type {
		...
		public int   unk_node;
		public float float_0x02;
		public float float_0x06;
		public float float_0x0a;
		public float float_0x0e;

		public TLHDSetTypeA_Entry_Item_Type_2(final ByteBuffer data) {
			super(data);
			int offset = data.position();
			unk_node = data.getShort();
	...
	public static class TLHDSetTypeA_Entry_Item_Type_3 extends TLHDSetTypeA_Entry_Item_Type {
		...
		public int   unk_node;
		public float float_0x06;
		public float word_0x0a;
		public float word_0x0c;

		public TLHDSetTypeA_Entry_Item_Type_3(final ByteBuffer data) {
			super(data);
			int offset = data.position();
			unk_node = data.getShort();
			data.position(offset + 0x6);
	...
	public static class TLHDSetTypeA_Entry_Item_Type_4 extends TLHDSetTypeA_Entry_Item_Type {
		...
		public float word_0x0a;
		public float word_0x0c;
		public float word_0x0e;
		public float word_0x10;
		public float word_0x12;
		public float word_0x14;

		public TLHDSetTypeA_Entry_Item_Type_4(final ByteBuffer data) {
			super(data);
			int offset = data.position();
			unk_node = data.getShort();
			data.position(offset + 0x2);
	...
	public static class TLHDSetTypeA_Entry_Item_Type_5 extends TLHDSetTypeA_Entry_Item_Type {
		...
		public TLHDSetTypeA_Entry_Item_Type_5(final ByteBuffer data) {
			super(data);
			int offset = data.position();
			unk_node = data.getShort();
			data.position(offset + 0x2);
