...
public class HavokNative {
	...
	static public native boolean getBonesWithNames(ByteBuffer buffer, String[] boneNames); //Fills a buffer with all the bone transform matrices based on a bone name list
