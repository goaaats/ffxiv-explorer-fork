...
public class COHDEntry {
    ...
    private final int unknown_a; //structEntry("unkn_a", UNSIGNED_CHAR_PACK, 5),
    private final int unknown_b; //structEntry("unkn_b", UNSIGNED_CHAR_PACK, 6),
    public final int type; // structEntry("type", UNSIGNED_CHAR_PACK, 7),
    ...
    private final int headerLength; //structEntry("headerLength", UNSIGNED_SHORT_PACK, 0xe),
